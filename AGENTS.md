# Crusher Development Guide

## Project Overview

Crusher is a terminal-based AI coding assistant built in Go by
...
internal/
  ...
  config/
    ...
    load.go                        crusher.json loading and validation
  ...
  hooks/                           Hook engine: runs user shell commands on hook events
    ...
    input.go                       Stdin payload builder, env vars, stdout parsing (Crusher + Claude Code compat)
...
- **Context files**: Crusher reads AGENTS.md, CRUSHER.md, CLAUDE.md, GEMINI.md
...
- **Pub/sub**: `internal/pubsub` for decoupled communication between agent,
  UI, and services.
- **Hooks**: User-defined shell commands in `crusher.json` that fire before
