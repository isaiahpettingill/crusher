...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_charmbracelet_crusher_internal_proto.Message"
                            }
                        }
                    },
                    "404": {
    ...
    "definitions": {
        ...
        "github_com_charmbracelet_crusher_internal_config.Config": {
            "type": "object",
            "properties": {
                "$schema": {
                    "type": "string"
                ...
                "options": {
                    "$ref": "#/definitions/github_com_charmbracelet_crusher_internal_config.Options"
                },
                "permissions": {
        ...
        "github_com_charmbracelet_crusher_internal_config.Options": {
            "type": "object",
            "properties": {
                "attribution": {
        ...
        "github_com_charmbracelet_crusher_internal_proto.Message": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "integer"
        ...
        "proto.Workspace": {
            ...
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_charmbracelet_crusher_internal_config.Config"
                },
                "data_dir": {
                    "type": "string"
                },
