...
import (
	...
	"github.com/isaiahpettingill/crusher/internal/ui/diffview"
)
...
type Styles struct {
	...
	// Header
	Header struct {
		Charm             lipgloss.Style // Style for the compact brand label.
	...
	Logo struct {
		...
		SmallCharm         lipgloss.Style // Brand label in SmallRender
