...
// to re-enable strict mode globally. Not exposed in crusher.json; this is
...
//     to "". Opt in to strict behavior per-reference with
...
func ExpandValue(ctx context.Context, value string, env []string) (string, error) {
	...
	// verbatim, with no CRUSHER/AGENT/AI_AGENT injection: callers of
