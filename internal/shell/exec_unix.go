...
// fully detached from Crusher's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to Crusher's process
// group.
...
// from Crusher's session and controlling terminal.
//
