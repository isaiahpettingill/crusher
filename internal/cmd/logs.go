...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View crusher logs",
	Long:  `View the logs generated by Crusher. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.Config().Options.DataDirectory, "logs", "crusher.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a crusher project. No logs found.")
			return nil
		}
