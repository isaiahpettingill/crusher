Get Crusher's current runtime state: active model, provider, LSP/MCP status, skills, hooks, permissions, and disabled tools. No parameters needed.
...
- Pair with the crusher-config skill to fix configuration issues
</tips>
