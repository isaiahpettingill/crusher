...
func createTestLogFile(t *testing.T, entries []map[string]any) string {
	t.Helper()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crusher.log")
...
func TestNewCrusherLogsTool(t *testing.T) {
	t.Parallel()
	tool := NewCrusherLogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, CrusherLogsToolName, tool.Info().Name)
}

func TestCrusherLogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runCrusherLogs(logFile, CrusherLogsParams{Lines: 3})
...
func TestCrusherLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runCrusherLogs(logFile, CrusherLogsParams{Lines: 0})
...
func TestCrusherLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runCrusherLogs(logFile, CrusherLogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestCrusherLogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runCrusherLogs("/nonexistent/path/crusher.log", CrusherLogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestCrusherLogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crusher.log")
	...
	result := runCrusherLogs(logFile, CrusherLogsParams{Lines: 50})
	require.Contains(t, result, "Log file is empty")
}

func TestCrusherLogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crusher.log")
	...
	result := runCrusherLogs(logFile, CrusherLogsParams{Lines: 10})
...
func TestCrusherLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runCrusherLogs(logFile, CrusherLogsParams{Lines: 1})
...
func TestCrusherLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestCrusherLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestCrusherLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestCrusherLogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crusher.log")
...
func TestCrusherLogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "crusher.log")
...
func TestCrusherLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestCrusherLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestCrusherLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestCrusherLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runCrusherLogs(logFile, CrusherLogsParams{Lines: 5})
...
func TestCrusherLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
