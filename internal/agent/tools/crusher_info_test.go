...
func TestCrusherInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildCrusherInfo(cfg, nil, nil, nil, nil)
...
func TestCrusherInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/crusher/crusher.json",
		"/project/.crusher/crusher.json",
	)
	output := buildCrusherInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/crusher/crusher.json")
	require.Contains(t, output, "/project/.crusher/crusher.json")
}

func TestCrusherInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildCrusherInfo(cfg, mgr, nil, nil, nil)
...
func TestCrusherInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.crusher",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.crusher")
	require.Contains(t, output, "debug = true")
}

func TestCrusherInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildCrusherInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildCrusherInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestCrusherInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "crusher.json")
	...
	output := buildCrusherInfo(store, nil, nil, nil, nil)
...
func TestCrusherInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "crusher-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("crusher-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildCrusherInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "crusher-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestCrusherInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "crusher-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestCrusherInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestCrusherInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
